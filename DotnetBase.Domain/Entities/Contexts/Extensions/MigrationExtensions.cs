namespace DotnetBase.Domain.Entities.Contexts.Extensions
{
    ...
    public static class MigrationExtensions
    {
            ...
            params TEntity[] entities) where TEntity : BaseEntity
        {
            ...
            foreach (var entity in entities)
            {
                ...
                var predicate = Expression.Lambda<Func<TEntity, bool>>(Expression.Equal(identifierExpression.Body, Expression.Constant(v)), identifierExpression.Parameters);
